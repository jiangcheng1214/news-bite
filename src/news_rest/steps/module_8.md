...
> This retrieves the auth token for admin

curl -X POST -F 'username=admin' -F 'password=123456' http://localhost:8000/api-token-auth/

http post http://localhost:8000/api-token-auth/ username=admin password=123456


> This will retrieve all items

curl -X GET -H 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' http://localhost:8000/item/

http http://localhost:8000/item/ 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68'


> This will retreive a single item

curl -X GET -H 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' http://localhost:8000/item/8ca4acfa-049e-40a1-9894-eed9190572e8/

http http://localhost:8000/item/8ca4acfa-049e-40a1-9894-eed9190572e8/ 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' http://localhost:8000/order/

http http://localhost:8000/order/ 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68'

> This will place an order for item id = 8ca4acfa-049e-40a1-9894-eed9190572e8 quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' -d '{"item": "8ca4acfa-049e-40a1-9894-eed9190572e8", "quantity": "1"}' http://localhost:8000/order/

http http://localhost:8000/order/ 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' item="8ca4acfa-049e-40a1-9894-eed9190572e8" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68' http://localhost:8000/order/**your_order_uuid**/

http http://localhost:8000/order/**your_order_uuid**/ 'Authorization: Token edd9075e52cbe0f0f1a6621334db01070552fc68'
